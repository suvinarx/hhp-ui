...
export default function About() {
  ...
  const founder = {
    ...
    bio: "Suhani Sahai has been a passionate advocate for homeless rights for over 4 years. With a background in social work and community organizing, Suhani founded HelpingHeartNetwork to create a centralized platform for resources and support. Her dedication and innovative approach have helped thousands of individuals find housing and stability.",
